import 'package:bike_rental_app/bikes/bike_types.dart';
...
class BookBike extends StatefulWidget {
  final Bike bike;
  const BookBike({super.key,required this.bike});
...
class _BookBikeState extends State<BookBike> {
  ...
  List<Widget> buildPageIndicator(){
    ...
    for (var i = 0; i < widget.bike.images.length; i++) {
      list.add(buildIndicator(i == currentImage));
    }
    return list;
  }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: [
                          buildSpecificationBike("Color", "White"),
                          buildSpecificationBike("Gearbox", "Automatic"),
                          buildSpecificationBike("Seat", "4"),
                          buildSpecificationBike("Motor", "v10 2.0"),
                          buildSpecificationBike("Speed (0-100)", "3.2 sec"),
                          buildSpecificationBike("Top Speed", "121 mph"),
                        ],
                      ),
                    ),
